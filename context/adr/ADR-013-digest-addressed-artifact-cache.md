# ADR-013: Digest-addressed artifact cache
...
Promote downloaded artifacts into cache by cryptographic digest once identity is verified/computed.

## Alternatives considered

- **URL-only cache keys:** not selected for the current architecture.

## Why this decision

- Avoid URL cache poisoning.
- Deduplicate mirrors.
...
Revisit if repository-native content identity offers stronger stable semantics.
