...
- Rootless execution model: `design/rootless-execution-model.md`.
- Rootless execution counter-proposal (draft): [verified environments per command](design/rootless-execution-counter-proposal.md).
